...
struct rfs_superblock{
    ...
    int inodeblock_used; // num of inodes block used to not mess up inodes.
    int inode_used; // num of inodes in a block in use.
    int datablock_used; // num of datablock in use 
};
